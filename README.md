# 📹 SECourses Video and Image Upscaler Pro - Complete User Guide
...
Create text files with the same name as your videos.
```
video.mp4       → video.txt
...
### ▦ Tiling Mode - Ultra High Resolution Processing **[ADVANCED]**
